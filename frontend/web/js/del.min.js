...
function districts() {
    ...
    function zoomToDistrict(districtPolygon) {
        var bounds = new google.maps.LatLngBounds();
        districtPolygon.getPath().forEach(function (latLng) {
    ...
    districtsData.forEach(function (district) {
        ...
        var districtLabel = new google.maps.Marker({
            position: { lat: 41.649936, lng: 41.6338956 },
            map: map,
        ...
        // Button Click Event
        var button = document.querySelector('#' + district.name.replace(/\s/g, ''));
        button.addEventListener('click', function () {
            ...
            zoomToDistrict(districtPolygon);
        });
    });
}
