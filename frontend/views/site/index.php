        ...
        <div class="swiper-wrapper text-white shadow-black">
            ...
            <div class="swiper-slide destination" data-target="2">
                ...
                <div class="card-content">
                    ...
                    <footer>
                        <p>
                            Район "Аллея Героев" была открыта в 2012, концепция района символизирует новый центр Батуми. Красивые жилые комплексы и небоскребы создают атмосферу мегаполиса с шаговой доступностью к морю.  Прогулочные зоны, АРТ объекты, пальмы, создают уникальную атмосферу нового современного Батуми.
                        </p>
            ...
            <div class="swiper-slide destination" data-target="3">
                ...
                <div class="card-content">
                    ...
                    <footer>
                        <p>
                            Район "Новый бульвар" это молодой и современный район для инвестиций. Вы сможете найти самые разнообразные проекты воплощённые от международных застройщиков. Особое отличие района: парк спроектированный Испанский архитектором, большая детская площадка, бульвар, самый крупный торговый центр.
                        </p>
                        <a href="#" class="card-link-hover target popup-hide"><svg width="16" height="16">
                                <use xlink:href="/images/icons.svg#small-arrow"></use>
                            </svg></a>
            ...
            <div class="swiper-slide destination" data-target="4">
                ...
                <div class="card-content">
                    ...
                    <footer>
                        <p>
                            Район "Махинджаури" один из самых популярных районов для курортного отдыха. Бизнесменов и инвесторов привлекает, загородный формат отдыха, экологичная зона, близкое расположение к морю, много новых проектов в заверенной стадии.
                        </p>
                        <a href="#" class="card-link-hover target popup-hide"><svg width="16" height="16">
                                <use xlink:href="/images/icons.svg#small-arrow"></use>
                            </svg></a>
